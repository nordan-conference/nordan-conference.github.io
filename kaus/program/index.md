...
<table>
    <tr data-toggle="collapse" id="hazra" data-target=".hazra">
    ...
    <tr data-toggle="collapse" id="nkunzimana" data-target=".nkunzimana">
    ...
    <tr data-toggle="collapse" id="moura" data-target=".moura">
    ...
    <tr data-toggle="collapse" id="activites" data-target=".activites">
        <th style="font-weight: inherit"> 18:00 </th>
        <th style="font-weight: inherit"></th>
        <th style="font-weight: inherit"></th>
        <th><button style="padding: 0px 0px 0px 10px; border-width: 0px 0px 0px 0px" class="btn default"><i>Activities</i></button></th>
    </tr>
...
<table>
    <tr data-toggle="collapse" id="huang" data-target=".huang">
    ...
    <tr data-toggle="collapse" id="xerakia" data-target=".xerakia">
    ...
    <tr data-toggle="collapse" id="le" data-target=".le">
    ...
    <tr data-toggle="collapse" id="lunch" data-target=".lunch">
        <th style="font-weight: inherit"> 11:30 </th>
        <th style="font-weight: inherit"> - </th>
    ...
    <tr data-toggle="collapse" id="svensson" data-target=".svensson">
        <th style="font-weight: inherit"> 12:30 </th>
        <th style="font-weight: inherit"> - </th>
    ...
    <tr class="collapse svensson">
        ...
        <p>
            ...
            <i>Gibbs measure</i> and associated
            <i>partition function</i> of this system in thermal
    ...
    <tr data-toggle="collapse" id="andreasson" data-target=".andreasson">
    ...
    <tr data-toggle="collapse" id="testorf" data-target=".testorf">
        <th style="font-weight: inherit"> 13:30 </th>
        <th style="font-weight: inherit"> - </th>
    ...
    <tr data-toggle="collapse" id="break" data-target=".break">
        <th style="font-weight: inherit"> 14:00 </th>
        <th style="font-weight: inherit"> - </th>
        <th style="font-weight: inherit"> 14:30 </th>
        <th><button style="padding: 0px 0px 0px 10px; border-width: 0px 0px 0px 0px" class="btn default">
            <i>Break</i>
        </button></th>
    </tr>
    <tr data-toggle="collapse" id="eskandari" data-target=".eskandari">
        <th style="font-weight: inherit"> 14:30 </th>
        <th style="font-weight: inherit"> - </th>
    ...
    <tr data-toggle="collapse" id="ucakar" data-target=".ucakar">
    ...
    <tr data-toggle="collapse" id="pennanen" data-target=".pennanen">
