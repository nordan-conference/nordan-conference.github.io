...
<tr>
        ...
        <tr>
            ...
            <th style="font-weight: inherit; padding: 0px 0px 3px 10px">
            <p style="text-align: justify; margin: 0;">
                <strong style="color: #4aa3b6;">Abstract.</strong> Spheres are central objects in Cauchy-Riemann (CR) geometry as model hypersurfaces with rich symmetry groups. In particular, the embeddability of real hypersurfaces into spheres in higher-dimensional complex spaces has been extensively studied.</p>
