...
abstract:
    ...
    - In this talk, I will introduce the Kato square root estimate and
        describe the <i>first-order method</i>, a technique that reduces the
    ...
    - I will also present recent results in the theory, including extensions
        to Riemannian manifolds and to operators with <i>degenerate
        coefficients</i>, where the matrix $A(x)$ may lack uniform bounds or
