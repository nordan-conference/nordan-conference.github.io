...
<!--
  ...
  <div class="mathconf-schedule">
	...
	<span class="affil">University of Oslo (Norway)</span>
      ...
      <div class="mathconf-abstract">
	  <p>
        <i>Abstract.</i> Properties of images and preimages of a polynomial selfmap $P:K^n\rightarrow K^n$, here $K$ is $\mathbb{R}$ or $\mathbb{C}$, are useful for many questions in analysis and algebra. In this talk I will present 2 main results: </p>
<p>
